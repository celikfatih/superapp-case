...
import static com.fati.exchangerateservice.Constants.TRX_ID_HEADER_NAME;
import static com.fati.exchangerateservice.Constants.TRX_ID_LOG_NAME;
...
public class TransactionIdFilter implements Filter {
    ...
    public static final Supplier<String> GET_RANDOM_TRX = () -> UUID.randomUUID().toString()
            .replace("-", "");
